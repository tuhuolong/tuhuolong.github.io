...
tags: [浏览器, javascript, system, compiler, components, access]
---

![](http://img1.ph.126.net/fk_3qj71JAI73W4-kSQBvQ==/2769432295873312211.jpg)
Native Client:**本地程序**(C/C++和目前不支持的其他程序)**沙箱**
     [JavaScript通过浏览器(解释引擎)来完成功能,HTML5只是扩展了部分功能]
Native Client 适合**纯计算(CPU+内存)**本地程序,不适合 创建进程/直接访问文件/无限制访问网络 程序
![](http://img6.ph.126.net/vKGT3k5hiv3zwKzSlKNbcg==/2889903585905481386.jpg)
...
[http://www.chromium.org/nativeclient](http://www.chromium.org/nativeclient)

[https://developers.google.com/native-client/](https://developers.google.com/native-client/)
[http://www.chromium.org/nativeclient/design-documents/native-client-integration-with-chrome](http://www.chromium.org/nativeclient/design-documents/native-client-integration-with-chrome)

[http://www.chromium.org/nativeclient/getting-started/the-life-of-a-native-client-module](http://www.chromium.org/nativeclient/getting-started/the-life-of-a-native-client-module)

[http://www.chromium.org/nativeclient/getting-started/getting-started-background-and-basics](http://www.chromium.org/nativeclient/getting-started/getting-started-background-and-basics)
...
Conversely, with NPAPI or ActiveX (and see [FireBreath](http://www.firebreath.org/) which
...
Native Client is specifically designed to run native code
 securely inside web browsers, it puts web applications on "the same playing field" as local applications, providing the raw speed needed to compete with traditional
...
[Native
 Client](http://code.google.com/p/nativeclient/) is a software "sandbox" meant to [securely run native code inside a browser](http://www.theregister.co.uk/2011/08/12/google_adds_native_client_to_chrome_beta/)
...
[](http://www.theregister.co.uk/2011/09/12/google_native_client_from_all_sides/)[google_native_client_from_all_sides](http://www.theregister.co.uk/2011/09/12/google_native_client_from_all_sides/)

[google_native_client_from_all_sides_2](http://www.theregister.co.uk/2011/09/12/google_native_client_from_all_sides/page2.html)
[google_native_client_from_all_sides_3](http://www.theregister.co.uk/2011/09/12/google_native_client_from_all_sides/page3.html)
[google_native_client_from_all_sides_4](http://www.theregister.co.uk/2011/09/12/google_native_client_from_all_sides/page4.html)
...
An
 ordinary program will read a data value from memory into a register and then jump to the address that value represents. But with Native Client, the compiler performs a bit of arithmetic on that value *before* the jump to ensure it doesn't target bad
 instructions, and then the code verifier double-checks the compiler's work.

This
 proposition fits quite nicely with Chrome OS, the fledgling Google operating system that puts [all applications inside the browser](http://www.channelregister.co.uk/2011/05/13/the_chromebook_proposition/). With Chrome
...
[mozillas-rejection-of-nativeclient-hurts-the-open-web](http://chadaustin.me/2011/01/mozillas-rejection-of-nativeclient-hurts-the-open-web/)
